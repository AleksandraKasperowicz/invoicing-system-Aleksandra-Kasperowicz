...
export class CompanyRow {
  ...
  deleteBtn(): WebElement {
    return this.companyRow.element(by.css('.btn-outline-danger'))
  }
  ...
  private confirmUpdateCompanyBtn() {
    return this.companyRow.element(by.css('.btn-outline-primary'));
  }
  ...
  private editBtn() {
    return this.companyRow.element(by.css('.btn-outline-secondary'));
  }
}
